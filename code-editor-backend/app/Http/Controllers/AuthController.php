    ...
    public function login(Request $request)
{
    ...
    $token = JWTAuth::claims(['sub' => $user->id, 'role' => $user->role])->fromUser($user);
    ...
    {
        $user = Auth::user();
        Log::info('Logout request received', ['user' => $user->id]);

        Auth::logout();

        Log::info('User logged out successfully', ['user' => $user->id]);
        return response()->json([
            'status' => 'success',
